...
DAY=$(date '+%d')
# ~/notebook/oct-15.txt
export TODAYS_FILE=$NOTEBOOK/$MONTH-$DAY.jade

# we only create a new file if we run the 'morning' command
function morn {
  SCRIPT="good mornin' Craig. it's $(date '+%A, %B %e')"
  ...
  open -a Google\ Chrome https://dashboard.pantheon.io/organizations/7c6858eb-2259-4dac-9476-fd0190e1cc72#sites/sites
  open -a Google\ Chrome https://app5.workamajig.com/platinum
